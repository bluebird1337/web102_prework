...
function addGamesToPage(games) {
    ...
    for (const game of games){
        ...
        gameCard.innerHTML = `
        <img src="${game.img}" alt="${game.name} Image" style="max-width: 100%; height: auto;" />
            <h2>${game.name}</h2>
...
const displayStr = `A total of $${totalPledged.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently, ${
    numUnfundedGames === 1
...
const topFundedGameElement1 = document.createElement('div');
topFundedGameElement1.textContent = `Top funded game: ${firstGame.name}`;
firstGameContainer.appendChild(topFundedGameElement1);

// do the same for the runner up item
const topFundedGameElement2 = document.createElement('div');
topFundedGameElement2.textContent = `Second most funded game: ${secondGame.name}`;
secondGameContainer.appendChild(topFundedGameElement2);
